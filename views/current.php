      ...
      <div class="main-section">
     	<div class="container">
     		<div class="row">
                 ...
                 <li><a href="https://github.com/CodeWithOz" target="_blank"<i class="fab fa-github"></i></a></li>
                 <li><a href="https://medium.com/@ucheozoemena" target="_blank"<i class="fab fa-medium"></i></a></li>
                 </ul>
     					    <a href="../interns/ucheozoemena" class="btn-view">view profile</a>
     				</div>
     			</div>
     			<div class="col-md-3 col-sm-6 col-xs-12">
           <div class="intern-block border-blue">
